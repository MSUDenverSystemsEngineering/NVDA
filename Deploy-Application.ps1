...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "nvda_2017.4.exe" -Parameters "--install-silent" -WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "$envProgramFilesX86\NVDA\uninstall.exe" -WindowStyle "Hidden" -PassThru
